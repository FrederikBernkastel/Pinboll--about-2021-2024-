...
public enum CRCLR : ushort
{
    fBlack = CHARCOLOR.FOREGROUND_BLUE | CHARCOLOR.FOREGROUND_GREEN | CHARCOLOR.FOREGROUND_RED,
    bBlack = CHARCOLOR.BACKGROUND_BLUE | CHARCOLOR.BACKGROUND_GREEN | CHARCOLOR.BACKGROUND_RED,
}
